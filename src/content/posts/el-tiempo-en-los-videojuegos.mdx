...
Cada diseñador tiene, conscientemente o no, una relación personal con el tiempo que acaba imprimiéndose en su obra. Los juegos de Fumito Ueda son lentos porque la lentitud es su argumento. Los de FromSoftware son densos porque el tiempo entre error y error está cargado de significado.

Reconocer esa firma es aprender a leer videojuegos de otra manera: no como productos con mecánicas, sino como visiones de cómo debería sentirse el tiempo. Preguntar cómo un juego maneja el tiempo es preguntar qué clase de experiencia considera valiosa. Y esa pregunta dice más sobre un juego que cualquier análisis de sus sistemas.
